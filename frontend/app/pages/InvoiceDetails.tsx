              ...
              {invoice.signature && (
                <div className="bg-card border border-border rounded-lg p-4">
                  ...
                  <div className="space-y-2 text-sm">
                    <div>
                      <strong>Signed by:</strong> {invoice.signature.signerName}
                    </div>
                    <div>
                      <strong>Email:</strong> {invoice.signature.signerEmail}
                    </div>
                    <div>
                        ...
                        <div
                          className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                            event.type === "PAYMENT"
                              ...
                              : event.type === "SIGNED"
                                ? "bg-[var(--status-signed)] text-white"
          ...
          <Dialog open={showSendModal} onOpenChange={setShowSendModal}>
            <DialogContent className="sm:max-w-2xl">
              <DialogHeader>
                ...
                <DialogDescription>
                  Share these links with your client. After sending, editing
                  will be disabled.
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <CopyField
                  label="Sign Link (Client Acknowledgement)"
                  value={signUrl}
                />
                <div className="bg-muted border border-border rounded-md p-4 text-sm">
                  <strong>Note:</strong> After sending, you won&apos;t be able
                  to edit this invoice. Use &quot;Revise&quot; to create a new
                  version if changes are needed.
                </div>
              </div>
              <DialogFooter>
                <Button
          ...
          <Dialog open={showPaymentModal} onOpenChange={setShowPaymentModal}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Add a new payment for this invoice. Balance remaining: $
                  {balance.toFixed(2)}
                </DialogDescription>
              </DialogHeader>
              <div className="space-y-4 py-4">
